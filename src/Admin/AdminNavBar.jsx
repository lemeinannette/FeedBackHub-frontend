  ...
  return (
    <div className='flex items-center mt-2 justify gap-13 p-3  center flex-col h-full '>
      <div className='text-[12px] font-semibold text-gray-700 mt-4'>Welcome Back !</div>
        ...
        <Link to='/admin/report' className='text-[8px] flex items-center justify-center font-semibold p-1.5 w-[165px] cursor-pointer  text-gray-700 rounded-sm'><BiSolidReport   className='mr-2' color='teal' size={15}/>Report</Link>
       
        <button onClick={handleLogout} className='flex w-full bg-linear-to-r from-emerald-500 to-cyan-500 mt-15 text-white cursor-pointer rounded-md  shadow-md'> <div className=' flex  items-center justify-center p-1.5 text-[12px] rounded-md w-full hover:bg-red-400'><RiLogoutCircleLine  className='mr-3'/>Logout</div></button>
